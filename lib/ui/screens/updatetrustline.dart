...
class UpdateTrustlinePage extends StatefulWidget {
  const UpdateTrustlinePage({Key? key}) : super(key: key);

  @override
  _UpdateTrustlinePageState createState() => _UpdateTrustlinePageState();
}

class _UpdateTrustlinePageState extends State<UpdateTrustlinePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Update Trustline"),
      ),
        ...
        if (currentNetwork!.address != null) {
          if (addressController.text.isNotEmpty &&
            ...
            CreditLine data = CreditLine(
                ...
                wallet: wallet);
            apiBloc.add(ApiUpdateTrustline(data: data));
          } else {
